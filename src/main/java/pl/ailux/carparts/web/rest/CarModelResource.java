...
public class CarModelResource {
    ...
    private static final String ENTITY_NAME = "carPartsCarModel";
    ...
    public ResponseEntity<CarModelDTO> updateCarModel(@Valid @RequestBody CarModelDTO carModelDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, carModelDTO.getId().toString()))
            .body(result);
    }
